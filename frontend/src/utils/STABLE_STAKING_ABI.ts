...
export const STABLE_STAKING_ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_lendingPlatformAddress", type: "address" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "blocksPerWave", type: "uint256" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "wave", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract ILendingPlatform", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "uint256", name: "_blocksPerWave", type: "uint256" }],
  ...
  { inputs: [], name: "withdrawStakeAndRewards", outputs: [], stateMutability: "nonpayable", type: "function" },
] as const;
